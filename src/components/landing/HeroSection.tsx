      ...
      <div className="max-w-7xl mx-auto flex flex-col items-center text-center">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="relative">
              ...
              <div className="backdrop-blur-xl bg-white/40 rounded-3xl border border-white/20 shadow-2xl p-6 md:p-10 relative overflow-hidden w-full max-w-4xl mx-auto h-[580px] md:h-[620px]">
                ...
                <div className="relative h-full flex flex-col">
                  ...
                  <div className="flex-1 flex flex-col space-y-4 md:space-y-6 min-h-0">
                    ...
                    {/* Fixed height answer area with internal scrolling if needed */}
                    <div className={`bg-gradient-to-r from-slate-50 to-white rounded-xl text-left transition-all duration-700 ease-out flex-1 min-h-0 ${
                      showAnswer 
                        ? 'opacity-100 p-4 md:p-6 transform translate-y-0' 
                        : 'opacity-0 p-0 transform -translate-y-2 pointer-events-none'
                    }`}>
                      <div className="h-full flex flex-col overflow-hidden">
                        <div className="break-words flex-shrink-0">
