...
const HeroSection: React.FC<HeroSectionProps> = ({ openWaitlistModal }) => {
  ...
  const queries = [
    ...
    },
    {
      ...
      answer: "Geographic distribution of 2,400+ remote tech workers reveals surprising trends:",
      type: "geographic",
      bullets: [
    ...
    <section className="pt-32 pb-20 px-6 md:px-10 lg:px-0 overflow-hidden">
      <div className="max-w-7xl mx-auto flex flex-col items-center text-center">
        <div className="max-w-6xl mx-auto">
          <div className="mb-16">
            <h1 className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-light text-gray-900 leading-tight mb-8 tracking-tight">
